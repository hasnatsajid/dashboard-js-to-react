      ...
      <div className="row">
        <div className="col-12 col-lg-6">
          <div className="card border-0 shadow">
            <div className="card-header border-gray-100 d-flex justify-content-between align-items-center">
              <h2 className="h4 mb-0">Sweet alerts</h2>
              <a
                href="https://themesberg.com/docs/volt-bootstrap-5-dashboard/plugins/sweet-alerts/"
            ...
            <div className="card-body">
              ...
              <button className="btn btn-info" id="infoAlert">
                Info alert
              </button>
        ...
        <div className="col-12 col-lg-6">
          <div className="card border-0 shadow">
            <div className="card-header border-gray-100 d-flex justify-content-between align-items-center">
              ...
              <a
                href="https://themesberg.com/docs/volt-bootstrap-5-dashboard/plugins/notifications/"
                className="btn btn-outline-gray-500 d-inline-flex align-items-center"
              >
                <svg className="icon icon-xxs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path
