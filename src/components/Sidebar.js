        ...
        <ul className="nav flex-column pt-3 pt-md-0">
          ...
          <li className="nav-item">
            ...
            <div className="multi-level collapse" role="list" id="submenu-components" aria-expanded="false">
              <ul className="flex-column nav">
                <li className="nav-item">
                  <a className="nav-link" target="_blank" href="https://themesberg.com/docs/volt-bootstrap-5-dashboard/components/accordions/">
          ...
          <li className="nav-item">
            ...
            >
              ...
              <span className="sidebar-text">
                Documentation <span className="badge badge-sm bg-secondary ms-1 text-gray-800">v1.4</span>
              </span>
            </a>
          </li>
          <li className="nav-item">
          ...
          <li className="nav-item">
            <a href="../../pages/upgrade-to-pro.html" className="btn btn-secondary d-flex align-items-center justify-content-center btn-upgrade-pro">
